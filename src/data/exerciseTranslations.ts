...
const exerciseEnglishContent: Record<string, Partial<ExerciseDisplayFields>> = {
  ...
  'shoulder-neck-thoracic-extension-chair': {
    title: 'Chair-supported thoracic extension',
    description: 'Use a sturdy chair to gently move the upper back without forcing the neck backward.',
    detail: 'Keep the movement in the upper back and return before the neck feels strained.',
    steps: ['Sit on a sturdy chair.', 'Cross your arms over your chest and look forward.', 'Gently extend the upper back over the chair back.', 'Return upright and breathe normally.'],
    benefits: 'Supports comfortable upper-back mobility for shoulder-neck movement.',
    durationText: '5 reps',
  },
  'shoulder-neck-band-row-low': {
    title: 'Low band row',
    description: 'Use light resistance to build controlled shoulder-blade and upper-back endurance.',
    detail: 'Keep the band anchored securely and the elbows close to the body.',
    steps: ['Anchor a light band at chest height.', 'Sit or stand tall with the neck relaxed.', 'Pull the elbows back slowly without shrugging.', 'Return with control.'],
    benefits: 'Builds low-load scapular and upper-back endurance.',
    durationText: '2 sets of 8 reps',
  },
  'shoulder-neck-serratus-wall-push': {
    title: 'Wall serratus push',
    description: 'Use a wall to practise gentle shoulder-blade forward control.',
    detail: 'Keep the ribs and pelvis steady and avoid shrugging or arching the back.',
    steps: ['Stand facing a wall with hands at chest height.', 'Keep the body tall and elbows softly bent.', 'Press gently so the shoulder blades glide forward.', 'Return and breathe normally.'],
    benefits: 'Builds low-load serratus and scapular control.',
    durationText: '2 sets of 8 reps',
  },
  ...
  'ankle-gastrocnemius-stretch': {
    title: 'Wall gastrocnemius stretch',
    description: 'Stretch the back of the calf with the back knee straight and heel down.',
    detail: 'This straight-knee version describes a gastrocnemius-focused calf stretch with stable wall support.',
    steps: ['Face a wall and place both hands on it.', 'Step one foot back with the heel down and knee straight.', 'Lean toward the wall until you feel a gentle calf stretch.', 'Hold for 20 to 30 seconds, then switch sides.'],
    benefits: 'Supports gentle calf flexibility and ankle range of motion.',
    durationText: '2 rounds per side, 20 to 30 seconds each',
  },
  'ankle-soleus-stretch': {
    title: 'Wall soleus stretch',
    description: 'Stretch the deeper calf with the back heel down and knee slightly bent.',
    detail: 'This bent-knee version describes a soleus-focused calf stretch with stable wall support.',
    steps: ['Face a wall and place both hands on it.', 'Step one foot back and keep the heel down.', 'Bend the back knee slightly and lean forward slowly.', 'Hold the gentle stretch for 20 to 30 seconds, then switch sides.'],
    benefits: 'Supports gentle deeper-calf flexibility and ankle range of motion.',
    durationText: '2 rounds per side, 20 to 30 seconds each',
  },
  'ankle-seated-soleus-raise': {
    title: 'Seated bent-knee calf raise',
    description: 'Lift both heels slowly while seated with the knees bent.',
    detail: 'A low-load starting option for calf and ankle strength before supported standing raises.',
    steps: ['Sit on a sturdy chair with both feet flat.', 'Keep the knees about 90 degrees bent.', 'Lift both heels slowly and pause briefly.', 'Lower with control and keep breathing.'],
    benefits: 'Builds lower-leg support with a stable seated setup.',
    durationText: '2 sets of 10 reps',
  },
  ...
  'catalog-bench-press': { title: 'Dumbbell bench press', description: 'Press light dumbbells from the chest with control.', detail: 'A catalog-only resistance example; complete the safety check and choose a controllable load first.', steps: ['Lie on a stable surface with feet supported.', 'Press the dumbbells slowly from the chest.', 'Keep the elbows from flaring excessively.', 'Lower the dumbbells with control.'], benefits: 'Provides a chest and upper-body pushing reference.', durationText: '2 sets of 8 reps' },
  'catalog-shoulder-press': { title: 'Seated dumbbell shoulder press', description: 'Use light dumbbells for a controlled seated shoulder press.', detail: 'Catalog-only resistance content; do not use as a default recommendation when shoulder symptoms are present.', steps: ['Sit on a stable chair with back support.', 'Start with the dumbbells beside the shoulders.', 'Press only through a comfortable range.', 'Lower slowly.'], benefits: 'Provides an upper-body pushing reference.', durationText: '2 sets of 8 reps' },
  'catalog-squat': { title: 'Chair squat', description: 'Use a sturdy chair as support for a controlled squat.', detail: 'Catalog-only lower-body content; adjust depth to pain and control.', steps: ['Stand in front of a sturdy chair.', 'Reach the hips back with knees tracking the toes.', 'Lightly touch the chair.', 'Stand with control.'], benefits: 'Provides a functional hip and leg strength reference.', durationText: '2 sets of 8 reps' },
  'catalog-pull-up': { title: 'Pull-up', description: 'Use a fixed bar for a controlled bodyweight pull.', detail: 'Catalog-only advanced content; it is not an active-aging default recommendation.', steps: ['Confirm the bar is secure.', 'Grip the bar and set the shoulder blades.', 'Pull with control.', 'Lower slowly without jumping down.'], benefits: 'Provides an upper-body pulling reference.', durationText: '2 sets of 3 reps' },
  'catalog-dip': { title: 'Parallel-bar dip', description: 'Use stable parallel bars for a controlled upper-body push.', detail: 'Catalog-only advanced content; shoulder control and stable equipment are required.', steps: ['Confirm the bars are stable.', 'Support the body with steady shoulders.', 'Lower only through a controlled range.', 'Press back to the start.'], benefits: 'Provides an upper-body pushing reference.', durationText: '2 sets of 3 reps' },
  'catalog-lat-pulldown': { title: 'Band lat pulldown', description: 'Use a secured band to practise a controlled downward pull.', detail: 'Catalog-only pulling content; the anchor and resistance must be secure.', steps: ['Secure the band above head height.', 'Keep the trunk steady.', 'Pull the elbows down toward the body.', 'Return slowly.'], benefits: 'Provides a back and shoulder-blade control reference.', durationText: '2 sets of 8 reps' },
  'catalog-seated-row': { title: 'Seated row', description: 'Use a resistance band for a controlled seated row.', detail: 'Catalog-only pulling content; keep the shoulders relaxed and resistance light.', steps: ['Sit steadily and secure the band.', 'Pull the hands toward the body.', 'Move the shoulder blades back and down.', 'Return slowly.'], benefits: 'Provides an upper-back and shoulder-blade control reference.', durationText: '2 sets of 8 reps' },
};
