export default {
  en: {
    ...
    progress: {
      ...
      latestOutcomeValue: 'Score {score}/5 · {date}',
    ...
    outcomes: {
      ...
      scoreLabels: {
        0: 'Not smooth at all', 1: 'Very difficult',
        2: 'Limited',
        3: 'Limited',
        4: 'Comfortable',
        5: 'In control', 6: 'A little smooth', 7: 'Smooth', 8: 'Very smooth', 9: 'Extremely smooth', 10: 'Best today',
      },
  ...
  'zh-TW': {
    ...
    progress: {
      ...
      latestOutcomeValue: '{date} · {score}/5 分',
      noOutcomeYet: '尚未確認',
    },
    outcomes: {
      title: '恢復狀態確認',
      ...
      scoreLabels: {
        ...
        3: '不太順',
        4: '感覺順暢',
        5: '可以控制', 6: '有點順', 7: '感覺順暢', 8: '很順', 9: '非常順', 10: '最順',
      },
      noteLabel: '補充說明（選填）',
