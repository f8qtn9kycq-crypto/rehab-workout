export default {
  en: {
    ...
    exerciseVisual: {
      poseLabel: 'Side-view exercise pose',
      muscleMapLabel: 'Front / back muscle map',
      poseAlt: '{exercise} neutral side-view exercise pose',
      muscleMapAlt: '{exercise} front and back body map; P marks primary regions and S marks secondary regions',
      frontView: 'Front',
      backView: 'Back',
      fallbackAlt: '{exercise} {visual} unavailable; icon fallback shown',
      targetArea: 'Target area: {area}',
      equipment: 'Equipment: {equipment}',
      primaryLabel: 'Primary regions',
      secondaryLabel: 'Secondary regions',
      sitToStandPrimary: 'Glutes and front thighs',
      sitToStandSecondary: 'Trunk support and back thighs',
      patternLegend: 'P with diagonal stripes = primary; S with dots = secondary. Labels remain visible without color.',
    },
    activityVisual: {
      cyclingAlt: 'Cycling activity icon',
      resistanceAlt: 'Resistance activity icon',
      cyclingHelper: 'Cycling activity; no muscle map is shown.',
      resistanceHelper: 'Standalone resistance activity.',
    },
    progress: {
      ...
      education: {
        ...
        pain: 'Recovery status compares recent pain and function records without making medical claims.',
        function: 'Function check-ins show whether daily movement feels easier, steadier, or harder.',
        consistency: 'This week shows how much gentle training you completed recently.',
        insufficient: 'If there is not enough data yet, keep logging gently and check again later.',
      },
      recoveryStatus: 'Recovery status',
      recoveryStatusHelper: 'Use this as a gentle check-in, not a diagnosis. Adjust if pain rises.',
      painChange: 'Pain change',
      painChangeValue: '{before} → {after}',
      painChangeHelper: 'Average pain before and after training this week.',
      noPainChange: 'More records needed',
      thisWeek: 'This week',
      sessionsCompleted: '{count} sessions completed',
      trainedAreas: 'Body areas: {areas}',
      ...
      painAverages: 'Pain average: {before} before → {after} after',
      notEnoughLogs: 'Finish more sessions to see a clearer pain trend.',
      functionHelper: 'Use the check-in below to track how daily movement feels.',
      sessions: '{count} sessions this week',
      latestOutcomes: 'Latest function check-ins',
      latestOutcomeValue: 'Score {score}/10 · {date}',
    ...
    outcomes: {
      ...
      questions: {
        ...
        hip: 'How steady does hip movement or sit-to-stand feel today?',
        shoulder_neck: 'How comfortable does shoulder-neck movement feel today?',
        knee: 'How comfortable do walking, stairs, or knee bending feel today?',
        ankle: 'How stable does standing, walking, or balancing feel today?',
      },
      latestForArea: 'Latest: {score}/10 on {date}',
      scoreLabel: 'How did it feel?',
      scoreHelper: '0 means not smooth at all. 10 means very smooth.',
      scoreLabels: {
        0: 'Not smooth at all',
        1: 'Very difficult',
        2: 'Very limited',
  ...
  'zh-TW': {
    ...
    exerciseVisual: {
      poseLabel: '側視動作姿勢',
      muscleMapLabel: '正面／背面肌群圖',
      poseAlt: '{exercise}中立側視動作姿勢示意圖',
      muscleMapAlt: '{exercise}正面與背面身體圖；P 標示主要區域，S 標示輔助區域',
      frontView: '正面',
      backView: '背面',
      fallbackAlt: '{exercise}的{visual}無法顯示，改用圖示',
      targetArea: '目標部位：{area}',
      equipment: '器材：{equipment}',
      primaryLabel: '主要訓練區域',
      secondaryLabel: '輔助訓練區域',
      sitToStandPrimary: '臀部與大腿前側',
      sitToStandSecondary: '軀幹穩定與大腿後側',
      patternLegend: 'P 加斜線代表主要區域；S 加圓點代表輔助區域，不只依賴顏色辨識。',
    },
    activityVisual: {
      cyclingAlt: '騎車活動圖示',
      resistanceAlt: '阻力活動圖示',
      cyclingHelper: '騎車活動不顯示肌群圖。',
      resistanceHelper: '獨立補記的阻力活動。',
    },
    progress: {
      title: '本週進度',
      ...
      education: {
        title: '如何閱讀這份摘要',
        pain: '恢復狀態會整理近期疼痛與功能紀錄，但不代表醫療診斷。',
        function: '功能確認用來觀察日常動作是否比較順、比較穩或比較吃力。',
        consistency: '本週訓練顯示最近完成了多少溫和訓練。',
        insufficient: '資料還不夠時，先穩定記錄，之後再回來查看趨勢。',
      },
      recoveryStatus: '恢復狀態',
      recoveryStatusHelper: '把這裡當作溫和提醒，不是診斷。若疼痛上升，請調整強度。',
      painChange: '疼痛變化',
      painChangeValue: '{before} → {after}',
      painChangeHelper: '本週訓練前後的平均疼痛變化。',
      noPainChange: '需要更多紀錄',
      thisWeek: '本週訓練',
      sessionsCompleted: '完成 {count} 次',
      trainedAreas: '訓練部位：{areas}',
      recoveryTrend: '恢復趨勢',
      functionTrend: '功能趨勢',
      consistency: '持續性',
      trends: {
        ...
        steady: '維持穩定',
        declining: '需要留意',
        not_enough_data: '資料還不夠',
      },
      painAverages: '平均疼痛：訓練前 {before} → 訓練後 {after}',
      notEnoughLogs: '完成更多訓練後，疼痛趨勢會更清楚。',
      functionHelper: '用下方功能確認，記錄日常動作感覺。',
      sessions: '本週 {count} 次訓練',
      latestOutcomes: '最新功能確認',
      latestOutcomeValue: '{date} · {score}/10 分',
      noOutcomeYet: '尚未確認',
    },
    outcomes: {
      title: '恢復狀態確認',
      ...
      questions: {
        ...
        hip: '今天髖部活動或起身穩定度如何？',
        shoulder_neck: '今天肩頸活動感覺有多放鬆？',
        knee: '今天走路、上下樓或彎膝感覺如何？',
        ankle: '今天站立、走路或平衡感覺有多穩？',
      },
      latestForArea: '上次：{date}，{score}/10 分',
      scoreLabel: '今天感覺如何？',
      scoreHelper: '0 代表完全不順，10 代表非常順。',
      scoreLabels: {
        0: '完全不順',
        1: '非常不順',
        2: '很不順',
