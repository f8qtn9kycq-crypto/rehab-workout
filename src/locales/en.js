export default {
  ...
  progress: {
    ...
    weekStart: 'Week starts {date}',
    recoveryTrend: 'Recovery Trend',
    functionTrend: 'Function Trend',
    consistency: 'Consistency',
    sessions: '{count} sessions logged this week',
    painAverages: 'Average pain: before {before}, after {after}',
    notEnoughLogs: 'Not enough data yet. Keep logging after sessions.',
    functionHelper: 'Compares the two most recent scores for the same body area.',
    latestOutcomes: 'Latest function scores by body area',
    latestOutcomeValue: '{score}/5 on {date}',
    noOutcomeYet: 'Not logged yet',
    noAreas: 'No body areas logged this week yet',
    areaSeparator: ', ',
    trends: {
      not_enough_data: 'Not enough data yet',
      lower: 'Pain trend looks lower this week',
      higher: 'Pain trend looks higher, so keep the next session gentler',
      steady: 'Trend looks steady',
  ...
  outcomes: {
    ...
    subtitle: 'Track daily function with one simple question. This is not a diagnosis or treatment result.',
    bodyAreaLabel: 'Choose body area',
    questionLabel: "Today's function question",
    scoreLabel: 'How does it feel today?',
    noteLabel: 'Note (optional)',
    notePlaceholder: 'Example: stairs felt steadier; reaching still feels tight',
    save: 'Save function score',
    latestForArea: 'Latest: {score}/5 on {date}',
    questions: {
      shoulder_neck: 'Is turning your head getting easier?',
      shoulder: 'Is reaching or lifting your arm in daily tasks getting easier?',
      hip: 'Is putting on socks or walking getting easier?',
      knee: 'Are stairs getting easier?',
      ankle: 'Does walking feel more stable?',
    },
    scoreLabels: {
      1: 'Very difficult',
      2: 'Difficult',
