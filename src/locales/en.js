export default {
  ...
  onboarding: {
    badge: 'Safety first',
    title: 'Which area would you like to support today?',
    subtitle: 'Choose one area. We will first check whether today is suitable for exercise, then show easier-to-control options.',
    bodyAreaTitle: 'Choose a body area',
    selectBodyArea: 'Choose one area to continue.',
    start: 'See where to start today',
    browse: 'Browse all exercises first',
  },
  bodyAreas: {
