export default {
  ...
  exercises: {
    ...
    mode: 'Mode',
    recommendedMode: "Today's Suitable Movements",
    recommendedHelper: 'Filtered for your current status',
    ...
    countBadge: '{count}',
    unavailableFilter: '{label} has no matching exercises',
    empty: 'No exercises match these filters. Try adjusting the filters.',
    emptyTitle: 'No exact matches found',
    emptyMessage: 'No exercises match the selected equipment and level. Try clearing filters, switching to beginner level, or choosing bodyweight movements.',
    emptyClearAction: 'Clear filters',
    emptyBodyweightAction: 'Try bodyweight exercises',
    emptyRecommendedAction: "Back to Today's Suitable Movements",
