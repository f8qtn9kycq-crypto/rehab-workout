...
,
  ...
  assessment: {
    ...
    selectedAreaLabel: 'Today’s selected area',
    changeArea: 'Change area',
    keepSelectedArea: 'Keep {bodyArea}',
    conditionTitle: 'How does this area feel today?',
    continueToSettings: 'Continue to training settings',
    settingsTitle: 'Set up today’s training',
    settingsSummary: '{bodyArea} · current pain {pain}/10',
    backToCondition: 'Back to today’s condition',
