...
,
  ...
  "plan": "七日安排",
  "planHint": "可調整日期；下肢／推／拉只是主要方向，可混合其他動作。安排不代表完成，也不是動作處方。",
  "rest": "休息",
  "editPlan": "調整安排",
  "days": {
    "0": "週一",
...
,
  "title": "今日活動與本週進度",
  "summary": "阻力 {resistance}／3 次・騎車 {cycling}／4 趟，共 {minutes} 分鐘",
  "legacy": "舊動作紀錄保留，未歸入場次的動作不計入阻力次數。",
  "resistance": "記錄阻力訓練",
  "cycling": "記錄騎車",
  "recordOnly": "補記已發生的活動，包含未完成的嘗試。",
  ...
  "incomplete": "未完成",
  "minutes": "實際分鐘數",
  "response": "活動後肩髖等症狀相較活動前",
  "choose": "請選擇",
  "warning": "如果疼痛增加、出現麻木無力，或感覺不穩，請停止本次訓練，並建議諮詢醫師或物理治療師。動作的停止與疼痛紀錄會保守納入回饋。",
  "save": "儲存活動",
  "cancel": "取消",
  "history": "活動紀錄與隔天回饋",
  "minuteUnit": "分鐘",
  "logUnit": "筆動作",
  "nextDay": "隔天反應（選填，隔天補記）",
  "unknown": "尚未回報",
  "share": "可複製的週摘要",
  "localOnly": "長按選取摘要即可複製。資料只存在此瀏覽器，不會自動同步至 ChatGPT。",
  "saved": "已儲存",
  "error": "無法讀取或儲存活動，原資料未覆寫。請確認瀏覽器儲存空間與權限。",
  "focuses": {
    "lower": "下肢",
    "push": "推",
    "pull": "拉",
  ...
  "recommendations": {
    ...
    "missing": "已達目標，但隔天反應不足，先維持，不推定恢復良好。",
    "baseline": "反應穩定；缺少前週活動分鐘數，先維持並建立基準。",
    "volume": "本週至少一類活動分鐘數增加，先維持，不疊加進展。",
    "small": "規律與回饋穩定，分鐘數未增加。分鐘數不代表重量或組數；若這些也未增加且符合物理治療師指示，僅考慮一個熟悉動作每組加 1 下，其餘維持。"
  }
},
  entryDemo: {
    label: '示範情境',
  ...
  weeklyRoutine: {
    ...
    neckDay: '肩頸',
    startExercise: '開始此動作',
    sessionGuardHint: '提醒：開始動作時仍會套用既有安全檢查與訓練流程。',
  },
  onboarding: {
    badge: '安全優先',
    title: '今天先走一條安全開始路徑',
  ...
  exercises: {
    ...
    startingTitle: '今天可以從這些動作開始',
    startingReason: '根據你選擇的「{bodyArea}」、目前疼痛與動作信心，先顯示較容易控制的選擇。',
    filterTitle: '尋找動作',
    ...
    emptyClearAction: '清除篩選',
    emptyBodyweightAction: '試試無器材動作',
    emptyRecommendedAction: '回到今天適合的動作',
    viewDetail: '查看動作',
    setsUnit: '組',
    repsUnit: '次',
    restUnit: '秒休息',
  ...
  assessment: {
    ...
    functionalLabel: '今天日常動作感覺有多順？',
    painLevels: { 0: '沒有疼痛', 1: '非常輕微', 2: '輕微', 3: '輕微', 4: '中等', 5: '中等', 6: '中等', 7: '明顯', 8: '明顯', 9: '非常明顯', 10: '最嚴重' },
    confidenceLevels: { 0: '完全沒信心', 1: '非常低', 2: '偏低', 3: '有限', 4: '有限', 5: '可以控制', 6: '穩定', 7: '穩定', 8: '有信心', 9: '很有信心', 10: '非常有信心' },
    equipmentLabel: '可用器材',
    timeLabel: '今天可用時間',
    minutes: '{count} 分鐘',
    recommendation: '依你填寫的疼痛與動作信心，今天先從「{mode}」開始，採低衝擊、慢速度與可控制節奏。',
    recoveryMode: '恢復模式',
    beginnerPlan: '初學者計畫',
    standardPlan: '標準計畫',
  ...
  safety: {
    ...
    whyTitle: '為什麼先確認？',
    whyBody: '先確認今天沒有需要優先處理的狀況，再依疼痛與活動感覺提供較容易控制的選擇。',
  ...
  detail: {
    backToLibrary: '← 返回動作庫',
    enlargeVideo: '放大觀看影片',
    sectionNavLabel: '動作詳細內容區段',
    sectionOverview: '總覽',
    sectionSteps: '步驟',
    sectionSafety: '安全',
    sectionAdjustments: '調整',
    sectionStart: '開始',
    steps: '步驟',
    benefits: '效益',
  ...
  session: {
    ...
    stopReason: '停止原因',
    saveLog: '儲存紀錄',
    outcomePromptTitle: '要補一筆功能確認嗎？',
    outcomePromptBody: '訓練紀錄已儲存。用一個快速功能確認，可以幫助你之後比較日常動作感覺。',
    outcomePromptSaved: '這是選填。你的訓練紀錄已經保存，略過不會刪除紀錄。',
    outcomePromptAdd: '現在新增',
    outcomePromptSkip: '略過',
    savedTitle: '訓練已儲存',
    savedLocally: '這次訓練已儲存在這台裝置的瀏覽器中。',
    savedPain: '疼痛 {before} → {after}',
    savedCompleted: '完成 {completed} / {planned} 組。',
    savedStoppedEarly: '提早停止，完成 {completed} / {planned} 組。',
    savedAddOutcome: '補一個快速確認',
    savedReturnHome: '完成並回首頁',
    savedViewRecords: '查看已儲存紀錄',
    saveError: '這次訓練無法儲存在瀏覽器中。請先釋放裝置空間或調整瀏覽器隱私設定，再試一次。',
    activeHint: '慢慢做，保持呼吸。任何尖銳疼痛、麻、暈，請立即停止。',
    currentCue: '現在先做',
    instructionsAndSafety: '動作說明與安全提醒',
    stepsTitle: '完整步驟',
    cautionsTitle: '注意事項',
    stopRulesTitle: '出現以下狀況請停止',
  ...
  logs: {
    title: '訓練紀錄',
    subtitle: '引導訓練、補記訓練與活動紀錄都儲存在這台裝置。',
    ...
    setDetails: '每組細節（選填）',
    setDetailsHint: '肌力訓練需要時再記重量或每組次數；徒手或活動度訓練可留空。',
  ...
  manualWorkout: {
    ...
    back: '返回訓練紀錄',
    title: '補記訓練',
    hint: '記下實際完成的動作與每組數字。這是事後紀錄，不會開始引導訓練或推定疼痛程度。',
    date: '訓練日期',
    exerciseNumber: '動作 {number}',
    name: '動作名稱',
    equipment: '器材（選填）',
    setNumber: '第 {number} 組',
    weight: '重量 kg（選填）',
    ...
    addExercise: '新增動作',
    removeExercise: '移除動作',
    cyclingMinutes: '同次騎車分鐘（選填）',
    cyclingHint: '此欄只記錄實際時間，不會重複建立騎車活動或影響每週騎車建議。',
    cyclingSummary: '騎車 {minutes} 分鐘',
    save: '儲存這次訓練',
    saveError: '無法儲存，請檢查日期及每組次數；原有紀錄未被覆寫。',
    saved: '訓練已儲存。可在下方近期活動或詳細歷史查看。',
    recordTitle: '{date} · 補記訓練',
    setSummary: '第 {number} 組 {weight} × {reps} 次',
    noWeight: '未記重量',
    weightValue: '{value} kg',
    noPainData: '疼痛前後未提供；不納入復健建議。',
  },
  video: {
